...
def make_axis_options():
        ...
        extra_axis_options = {
                ...
                xyz_grid.AxisOption("[AgentAttention] First Pass sx,sy", str, aa_apply_field_sx_sy("aa_fp_sx_sy")),
                ...
                xyz_grid.AxisOption("[AgentAttention] Second Pass sx,sy", str, aa_apply_field_sx_sy("aa_sp_sx_sy")),
